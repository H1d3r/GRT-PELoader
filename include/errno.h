...
#define ERR_LOADER_CREATE_EXIT_THREAD   (0x10000208)
#define ERR_LOADER_CLEAN_G_MUTEX        (0x1000FF01)
#define ERR_LOADER_CLEAN_S_MUTEX        (0x1000FF02)
#define ERR_LOADER_FREE_LIBRARY         (0x1000FF03)
#define ERR_LOADER_UNLOCK_PE_IMAGE      (0x1000FF04)
#define ERR_LOADER_UNLOCK_BACKUP        (0x1000FF05)
#define ERR_LOADER_UNLOCK_TLS_BLOCK     (0x1000FF06)
#define ERR_LOADER_UNLOCK_MAIN_MEM      (0x1000FF07)
#define ERR_LOADER_FREE_PE_IMAGE        (0x1000FF08)
#define ERR_LOADER_FREE_BACKUP          (0x1000FF09)
#define ERR_LOADER_FREE_TLS_BLOCK       (0x1000FF0A)
#define ERR_LOADER_FREE_MAIN_MEM        (0x1000FF0B)
#define ERR_LOADER_RECOVER_INST         (0x1000FF0C)
