...
#define IMAGE_OPT_HEADER_MAGIC_32 0x010B
#define IMAGE_OPT_HEADER_MAGIC_64 0x020B

#ifdef _WIN64
    #define IMAGE_OPT_HEADER_MAGIC IMAGE_OPT_HEADER_MAGIC_64
#elif _WIN32
    #define IMAGE_OPT_HEADER_MAGIC IMAGE_OPT_HEADER_MAGIC_32
#endif
